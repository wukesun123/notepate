...
public class EditActivity_list extends AppCompatActivity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (context.getText()!=null){
                    ...
                    listcard.content=context.getText().toString();
                    listcard.title = title.getText().toString();
                    listcardDao.update(listcard);
    ...
    public void inint(){
        ...
        intent = getIntent();
        listcard = listcardDao.findListcard(intent.getStringExtra("time"));
//        Toast.makeText(getApplicationContext(), diary.content, Toast.LENGTH_SHORT).show();
        title.setText(listcard.title);
        context.setText(listcard.content);
    }
}
